export function TableTopPart(){
    return <div className="flex justify-between gap-4 p-2 ">
        <div>
        <form action="" className="" >
                <div className="flex items-center bg-white-500 rounded-sm w-64 h-8 outline outline-1 outline-gray-300 " >
                    <div className="p-3">
                    ...
                    <input type="search" className="outline-none w-full text-gray-900 border-gray-400 rounded-lg bg-white-500 " placeholder="Order ID or Transactions ID" />
                </div>
            </form>
        </div>
        <div className="flex gap-4">
            <button className="flex items-center gap-1 h-8 bg-white-500 p-2 outline outline-1 outline-gray-300">Sort
            ...
            <button className="bg-white-500 flex items-center p-2 h-8 outline outline-1 outline-gray-300 ">
