export function RevenueCard1({title,amount,orderCount}){
    return <div>
    <div className="bg-blue-700 hover:bg-blue-900 shadow-md rounded-t-md p-3">
    ...
    <div className="flex justify-between p-2">
        ...
        <div className="flex justify-between pl-4 pr-4 pt-2 pb-2 rounded-b-md bg-blue-900 text-white-500">
            <div><p>Next Payout date:</p></div>
            <div><p>Today, 06:00 PM</p></div>
        </div>
    </div>
}